...
my_component_load('report_unreg_komponen' );
...
$modulname = 'Laporan <i class="fa fa-caret-right fa-fw"></i> 
		Unreguler <i class="fa fa-caret-right fa-fw"></i> Data komponen &amp; item ';
...
if($task == "cetak_masal"){
	...
	header("Content-Disposition: attachment;filename=data_komponen_unreguler_{$periode['payroll_date']}_excel_all_".date('Ymd_His').".xls");
