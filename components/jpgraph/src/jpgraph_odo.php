...
// Ver:		$Id: jpgraph_odo.php 466 2006-02-04 12:09:36Z ljp $
//
...
//--- LineProperty
    ...
    function SetShadow($aShadow=true,$aColor="gray@0.5",$aDx=4,$aDy=4) {
...
class Odometer {
    ...
    public $iStyle;
    public $label;
    private $iFillColor = "lightgray:1.15", $iColor = "navy";
	...
	if( $this->iStyle == ODO_FULL ) 
	    $this->label->SetPos($this->xc, $this->yc + $this->iRadius*$this->label->iVPos,
	                      "center","bottom");
	else
	    $this->label->SetPos($this->xc, $this->yc - $this->iRadius*$this->label->iVPos,
                              "center","bottom");
