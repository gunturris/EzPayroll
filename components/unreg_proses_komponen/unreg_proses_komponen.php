...
my_component_load('unreg_proses_komponen' );
$task = isset($_GET['task']) ? $_GET['task'] : ''; 
$id = isset( $_GET['id'] ) ? $_GET['id']:  0;
$modulname = 'Proses gaji <i class="fa fa-caret-right fa-fw"></i> 
		Unreguler <i class="fa fa-caret-right fa-fw"></i> Komponen hasil';

if($task == "excel"){
	$komponen = my_get_data_by_id('pay_komponen_gaji', 'pay_komponen_gaji_id', $id);
	header("Content-Type: application/xls");;
	header("Content-Disposition: attachment;filename=kalkulasi_unreguler_komponen_{$komponen['pay_komponen_gaji_label']}_".date('Ymd_His').".xls");
