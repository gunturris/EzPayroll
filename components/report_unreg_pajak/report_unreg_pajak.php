...
my_component_load('report_unreg_pajak' );
...
$modulname = 'Laporan <i class="fa fa-caret-right fa-fw"></i> 
		Unreguler <i class="fa fa-caret-right fa-fw"></i> Perhitungan pajak ';
...
if($task == "cetak_masal"){
	...
	header("Content-Disposition: attachment;filename=pajak_".str_replace(" ","-",$periode['unreg_periode_name'])."_excel_all_".date('Ymd_His').".xls");
